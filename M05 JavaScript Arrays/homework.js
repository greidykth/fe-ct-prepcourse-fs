...
function incrementarPorUno(array) {
   ...
   // Tu código:
   var arrayIncrement = array.map((element) => element +1);
...
// console.log(cuentoElementos([18, 20, 19, 3, 2]));
...
function todosIguales(array) {
   ...
   // Tu código:
   return array.length ? array.every(element => element === array[0]) : false;
...
function mesesDelAño(array) {
   ...
   const newArray = array.filter(element => element === "Enero" || element === "Marzo" || element === "Noviembre");
